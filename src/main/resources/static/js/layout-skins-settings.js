...
var smartbgimage =
    ...
    "<img src='/static/img/pattern/graphy-xs.png' data-htmlbg-url='/static/img/pattern/graphy.png' width='22' height='22' class='margin-right-5 bordered cursor-pointer'>" +
    "<img src='/static/img/pattern/tileable_wood_texture-xs.png' width='22' height='22' data-htmlbg-url='/static/img/pattern/tileable_wood_texture.png' class='margin-right-5 bordered cursor-pointer'>" +
    "<img src='/static/img/pattern/sneaker_mesh_fabric-xs.png' width='22' height='22' data-htmlbg-url='/static/img/pattern/sneaker_mesh_fabric.png' class='margin-right-5 bordered cursor-pointer'>" +
    "<img src='/static/img/pattern/nistri-xs.png' data-htmlbg-url='/static/img/pattern/nistri.png' width='22' height='22' class='margin-right-5 bordered cursor-pointer'>" +
    "<img src='/static/img/pattern/paper-xs.png' data-htmlbg-url='/static/img/pattern/paper.png' width='22' height='22' class='bordered cursor-pointer'>";
