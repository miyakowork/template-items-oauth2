...
(function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        height: undefined,
        undefinedText: '-',
        sortName: 'id',//修改默认排序字段为id取代以前的undefined
        sortOrder: 'asc',
        sortStable: false,
        striped: false,
        columns: [[]],
        ...
        $.each(this.options.columns, function (i, columns) {
            ...
            $.each(columns, function (j, column) {
                ...
                html.push('<th' + sprintf(' title="%s"', column.titleTooltip),
                    ...
                    sprintf(' data-sortName="%s"', column.sortName),
                    '>');
    ...
    BootstrapTable.prototype.resetView = function (params) {
        ...
        if (this.options.height) {
            ...
            this.$tableContainer.css('height', (height - 60) + 'px');
        }
        ...
        // Assign the correct sortable arrow
        this.getCaret();
        this.$tableContainer.css('padding-bottom', (padding - 38) + 'px');
