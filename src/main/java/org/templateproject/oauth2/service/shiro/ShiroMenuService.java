...
@Service
@Transactional
public class ShiroMenuService extends SimpleBaseCrudService<OauthDepartment, Integer> {
     ...
     * @return 侧边栏菜单
     */
    public List<OauthMenu> findLeftMenuByRoleId(int roleId, int menuModuleId, String systemCode) {
