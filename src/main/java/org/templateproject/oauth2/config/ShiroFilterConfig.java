...
import org.templateproject.oauth2.config.support.filter.ForceLogoutFilter;
import org.templateproject.oauth2.config.support.filter.MyFormAuthenticationFilter;
import org.templateproject.oauth2.config.support.filter.SessionTimeoutFilter;
...
public class ShiroFilterConfig {
        ...
        public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager,
                ...
                filterChainDefinitionMap.put("/oauth21/**", "forceLogout,sto,user");
