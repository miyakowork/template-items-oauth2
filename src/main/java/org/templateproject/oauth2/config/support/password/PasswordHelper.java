package org.templateproject.oauth2.config.support.password;
...
public class PasswordHelper {
     ...
     * @return 加密后的用户密码
     */
    public String getPassword(OauthUser user) {
     ...
     * @return 加密后的密码
     */
    public String getPassword(OauthUser user, String plainPassword) {
