package org.templateproject.oauth2.config.support.realm;
...
import org.templateproject.oauth2.service.shiro.ShiroPermissionService;
import org.templateproject.oauth2.service.shiro.ShiroRoleService;
...
public class UserRealm extends AuthorizingRealm implements CacheConsts {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        OauthUser currentUser = shiroUserService.findByUserName(username);
        //获取当前用户的角色名称
